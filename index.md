...
<section class="hero">
  <h1 class="hero-title">Alex Sopio PhD</h1>
  <p class="hero-subtitle">Researcher in High Energy Physics &amp; AI</p>
  <p class="hero-affiliation">University of Edinburgh, Scotland</p>
